...
const static std::string maleFirstNames[countFirstNames] = {
        ...
        "Denis", "Vyacheslav", "Stanislav", "Yaroslav", "Zakhar",
        "Matvey", "Taras", "Savely", "Albert", "Filipp",
        "Ignat", "Eduard", "Rostislav", "David", "Miron",
        "Valeriy", "Mark", "Prokhor", "Arseniy", "Rodion",
        "Yulian", "Artemiy", "Timur", "Amir", "Igor",
        "Lazar", "Ruben", "Nazar", "Makar", "Ratmir",
        "Marat", "Lev", "Oscar", "Samuil", "Sergey",
        "Renat", "Serafim", "Tikhon", "Voldemar", "Emil",
        "Gordey", "Platon", "Pyotr", "Mark", "Sergey",
...
const static std::string maleLastNames[countLastNames] = {
        ...
        "Nikolayev", "Orlov", "Andreev", "Makarov", "Nikitin",
        "Zakharov", "Zaytsev", "Solovyov", "Borisov", "Yakovlev",
        "Grigoryev", "Romanov", "Vorobyov", "Sergeev", "Fomin",
        "Vinogradov", "Kuzmin", "Maximov", "Kiselev", "Markelov",
        "Medvedev", "Anisimov", "Grigoryev", "Gromov", "Sukhanov",
        "Maslov", "Shestakov", "Mironov", "Lobanov", "Karpov",
        "Afanasev", "Vlasov", "Melnikov", "Danilov", "Savelyev",
        "Zakharov", "Shestakov", "Lvov", "Titov", "Dmitriyev",
        "Kalinin", "Maslennikov", "Rozhkov", "Zimin", "Nikiforov",
        "Goncharov", "Yefimov", "Krylov", "Belov", "Molchanov",
        "Gerasimov", "Frolov", "Safonov", "Kotov", "Gavrilov",
        "Sitnikov", "Tarasov", "Konovalov", "Burov", "Rybakov",
        "Kharitonov", "Zubkov", "Kornilov", "Abramov", "Andreev",
...
const static std::string malePatronymics[countPatronymics] = {
        ...
        "Pavlovich", "Maximovich", "Ilich", "Stepanovich", "Grigoryevich",
        "Viktorovich", "Konstantinovich", "Arkadyevich", "Timofeevich", "Vladimirovich",
        "Valentinovich", "Valeryevich", "Romanovich", "Antonovich", "Semenovich",
        "Stanislavovich", "Yaroslavovich", "Evgenievich", "Artemovich", "Borisovich",
        "Leonidovich", "Nikitich", "Tarasovich", "Filippovich", "Daniilovich",
        "Savelyevich", "Rubenovich", "Vladislavovich", "Glebovich", "Platonovich",
        "Zakharovich", "Filimonovich", "Kirillovich", "Davidovich", "Arsenyevich",
        "Georgievich", "Anatolyevich", "Gavrilovich", "Alekseevich", "Petrovich",
        "Fomich", "Lukich", "Yakovlevich", "Elizarovich", "Moiseyevich",
        "Tikhonovich", "Sokratovich", "Feoktistovich", "Leonidovich", "Afanasevich",
        "Ignatievich", "Rudolfovich", "Solomonovich", "Kuzmich", "Gennadievich",
        "Germanovich", "Yulianovich", "Rostislavovich", "Romanovich", "Rubenovich",
